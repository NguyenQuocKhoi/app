        ...
        <View>
          <View
            ...
            <Image
              ...
              style={{height: 60, width: 60, borderRadius:50, marginLeft: 15,
          ...
          <View
          style={{borderRadius:10, height: 15, width: 15, backgroundColor:'rgb(9, 207, 68)',
          position:'absolute', marginLeft: 55, bottom: 30
        }}
          ></View>
        ) : (
         null
            ...
            <View
              ...
              <View style={{margin: -5}}>
                ...
                <Text
                  style={{marginLeft: 150, position: 'absolute', marginTop: 5}}>
